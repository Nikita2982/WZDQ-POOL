...
async def show_playlist_entrypoint(message: Message, state: FSMContext) -> None:
    ...
    caption = (
        ...
        "1. Нажми /start.\n"
        "2. Выбери нужную рубрику: Electronic, House или Rap.\n"
        "3. Если выбрал Rap, сначала укажи BPM-диапазон.\n"
        "4. Выбери тайминг: 30 минут или 60 минут.\n"
        "5. Дождись, пока бот соберет плейлист.\n"
        "6. Получи готовую подборку треков в чат.\n"
        "7. Закидывай треки в DJ-софт и играй сет.\n\n"
        "Если хочешь новую подборку:\n"
        "1. Нажми Повторить генерацию.\n"
        "2. Выбери 30 или 60 минут.\n"
        "3. Бот соберет новую версию и постарается не повторять уже выданные треки.\n\n"
        "Важно:\n"
